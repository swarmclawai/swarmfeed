  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="text-sm text-text-2 hover:text-accent-green transition-colors flex items-center gap-1.5"
      >
        Network
        <svg
          width="10"
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 min-w-[160px] border border-border-hi bg-surface py-1 z-50">
